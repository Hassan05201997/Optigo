...
public class MicrowaveDashboardNEC {
	...
	@Test(priority=2)
	public void MicrowaveDashboardNECMinutes() throws InterruptedException, IOException
	{
		Thread.sleep(1000);
		...
		WebElement home=wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//basic/div/navigation/nav/div/ul/li[1]/a")));
			...
			Thread.sleep(5000);
				...
				WebElement vendor =driver.findElement(By.xpath("//div[@class='col-xs-12 pxy-1 boxshadow bg-white borderrd mb-2 pb-0 filter-section-ipmv']/div/p-dropdown[2]/div"));
				vendor.click();
				WebElement NEC =driver.findElement(By.xpath("//div[@class='ui-dropdown-items-wrapper']/ul/li[2]"));
				NEC.click();
				Thread.sleep(25000);
				
				WebElement granularity =driver.findElement(By.xpath("//div[@class='selectbtn ui-selectbutton ui-buttonset ui-widget ui-corner-all ui-buttonset-6']/div[1]/span"));;
action.moveToElement(granularity).click().build().perform();
Thread.sleep(29000);
				...
				while(itr.hasNext()){
					...
					if(!mainWindow.equals(childWindow)){
						...
						File DestFile=new File("/root/Desktop/PMONBBEminute.png");
						...
						while(itr2.hasNext()){
							...
							if(!mainWindow.equals(childWindow2)){
								...
								File DestFile2=new File("/root/Desktop/PMONBBEFTPminute.png");
								...
								while(itr3.hasNext()){
									...
									if(!mainWindow.equals(childWindow3)){
										...
										File DestFile3=new File("/root/Desktop/PMONESMINUTE.png");
								...
								while(itr4.hasNext()){
									...
									if(!mainWindow2.equals(childWindow3)){
										...
										File DestFile4=new File("/root/Desktop/PMONESFTPminute.png");
	...
	@Test(priority=3)
	public void MicrowaveDashboardNECHour() throws InterruptedException, IOException
	{
		...
		while(itr.hasNext()){
			...
			if(!mainWindow.equals(childWindow)){
				...
				TakesScreenshot scrShot =((TakesScreenshot)driver);
				File SrcFile=scrShot.getScreenshotAs(OutputType.FILE);
				File DestFile=new File("/root/Desktop/PMONBBEhour.png");
				FileUtils.copyFile(SrcFile,DestFile);
				driver.close();
			}
		}
				...
				while(itr2.hasNext()){
					...
					if(!mainWindow.equals(childWindow2)){
						...
						TakesScreenshot scrShot2 =((TakesScreenshot)driver);
						File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
						File DestFile2=new File("/root/Desktop/PMONBBEFTPhour.png");
						FileUtils.copyFile(SrcFile2,DestFile2);
						driver.close();
					}
				}
						...
						while(itr3.hasNext()){
							...
							if(!mainWindow.equals(childWindow3)){
								...
								TakesScreenshot scrShot3 =((TakesScreenshot)driver);
								File SrcFile3=scrShot3.getScreenshotAs(OutputType.FILE);
								File DestFile3=new File("/root/Desktop/PMONEShour.png");
								FileUtils.copyFile(SrcFile3,DestFile3);
								driver.close();
						...
						while(itr4.hasNext()){
							...
							if(!mainWindow2.equals(childWindow3)){
								...
								TakesScreenshot scrShot4 =((TakesScreenshot)driver);
								File SrcFile4=scrShot4.getScreenshotAs(OutputType.FILE);
								File DestFile4=new File("/root/Desktop/PMONESFTPhour.png");
								FileUtils.copyFile(SrcFile4,DestFile4);
								driver.close();
	...
	@Test(priority=4)
	public void MicrowaveDashboardNECDay() throws InterruptedException, IOException
	{
		...
		while(itr.hasNext()){
			...
			if(!mainWindow.equals(childWindow)){
				...
				TakesScreenshot scrShot =((TakesScreenshot)driver);
				File SrcFile=scrShot.getScreenshotAs(OutputType.FILE);
				File DestFile=new File("/root/Desktop/PMONBBEday.png");
				FileUtils.copyFile(SrcFile,DestFile);
				driver.close();
			}
		}
				...
				while(itr2.hasNext()){
					...
					if(!mainWindow.equals(childWindow2)){
						...
						TakesScreenshot scrShot2 =((TakesScreenshot)driver);
						File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
						File DestFile2=new File("/root/Desktop/PMONBBEFTPday.png");
						FileUtils.copyFile(SrcFile2,DestFile2);
						driver.close();
					}
				}
						...
						while(itr3.hasNext()){
							...
							if(!mainWindow.equals(childWindow3)){
								...
								TakesScreenshot scrShot3 =((TakesScreenshot)driver);
								File SrcFile3=scrShot3.getScreenshotAs(OutputType.FILE);
								File DestFile3=new File("/root/Desktop/PMONESday.png");
								FileUtils.copyFile(SrcFile3,DestFile3);
								driver.close();
						...
						while(itr4.hasNext()){
							...
							if(!mainWindow2.equals(childWindow3)){
								...
								TakesScreenshot scrShot4 =((TakesScreenshot)driver);
								File SrcFile4=scrShot4.getScreenshotAs(OutputType.FILE);
								File DestFile4=new File("/root/Desktop/PMONESFTPday.png");
								FileUtils.copyFile(SrcFile4,DestFile4);
								driver.close();
	...
	@Test(priority=5)
	public void MicrowaveDashboardNECWeek() throws InterruptedException, IOException
	{
		...
		while(itr.hasNext()){
			...
			if(!mainWindow.equals(childWindow)){
				...
				TakesScreenshot scrShot =((TakesScreenshot)driver);
				File SrcFile=scrShot.getScreenshotAs(OutputType.FILE);
				File DestFile=new File("/root/Desktop/PMONBBEweek.png");
				FileUtils.copyFile(SrcFile,DestFile);
				driver.close();
			}
		}
				...
				while(itr2.hasNext()){
					...
					if(!mainWindow.equals(childWindow2)){
						...
						TakesScreenshot scrShot2 =((TakesScreenshot)driver);
						File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
						File DestFile2=new File("/root/Desktop/PMONBBEFTPweek.png");
						FileUtils.copyFile(SrcFile2,DestFile2);
						driver.close();
					}
				}
						...
						while(itr3.hasNext()){
							...
							if(!mainWindow.equals(childWindow3)){
								...
								TakesScreenshot scrShot3 =((TakesScreenshot)driver);
								File SrcFile3=scrShot3.getScreenshotAs(OutputType.FILE);
								File DestFile3=new File("/root/Desktop/PMONESweek.png");
								FileUtils.copyFile(SrcFile3,DestFile3);
								driver.close();
						...
						while(itr4.hasNext()){
							...
							if(!mainWindow2.equals(childWindow3)){
								...
								TakesScreenshot scrShot4 =((TakesScreenshot)driver);
								File SrcFile4=scrShot4.getScreenshotAs(OutputType.FILE);
								File DestFile4=new File("/root/Desktop/PMONESFTPweek.png");
								FileUtils.copyFile(SrcFile4,DestFile4);
								driver.close();
	...
	@Test(priority=6)
	public void MicrowaveDashboardNECMonth() throws InterruptedException, IOException
	{
		...
		while(itr.hasNext()){
			...
			if(!mainWindow.equals(childWindow)){
				...
				TakesScreenshot scrShot =((TakesScreenshot)driver);
				File SrcFile=scrShot.getScreenshotAs(OutputType.FILE);
				File DestFile=new File("/root/Desktop/PMONBBEmonth.png");
				FileUtils.copyFile(SrcFile,DestFile);
				driver.close();
			}
		}
				...
				while(itr2.hasNext()){
					...
					if(!mainWindow.equals(childWindow2)){
						...
						TakesScreenshot scrShot2 =((TakesScreenshot)driver);
						File SrcFile2=scrShot2.getScreenshotAs(OutputType.FILE);
						File DestFile2=new File("/root/Desktop/PMONBBEFTPmonth.png");
						FileUtils.copyFile(SrcFile2,DestFile2);
						driver.close();
					}
				}
						...
						while(itr3.hasNext()){
							...
							if(!mainWindow.equals(childWindow3)){
								...
								TakesScreenshot scrShot3 =((TakesScreenshot)driver);
								File SrcFile3=scrShot3.getScreenshotAs(OutputType.FILE);
								File DestFile3=new File("/root/Desktop/PMONESmonth.png");
								FileUtils.copyFile(SrcFile3,DestFile3);
								driver.close();
						...
						while(itr4.hasNext()){
							...
							if(!mainWindow2.equals(childWindow3)){
								...
								TakesScreenshot scrShot4 =((TakesScreenshot)driver);
								File SrcFile4=scrShot4.getScreenshotAs(OutputType.FILE);
								File DestFile4=new File("/root/Desktop/PMONESFTPmonth.png");
								FileUtils.copyFile(SrcFile4,DestFile4);
								driver.close();
